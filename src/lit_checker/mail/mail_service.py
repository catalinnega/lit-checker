...
class MailService:
    ...
    def send_mail(self, mail_title_type: str, mail_content_type: str, mail_content: str) -> None:
        ...
        smtp_sender.quit()
        self.log.info(f"Sent message to {self.mail_account_config.to_address} succesfully")
